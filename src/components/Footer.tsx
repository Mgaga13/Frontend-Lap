        ...
        <div className='grid grid-cols-1 gap-8 lg:grid-cols-3'>
          ...
          <div className='sm:block flex flex-col items-center'>
            ...
            <ul className='mt-8 flex gap-6'>
              <li className='text-neutral-700 transition hover:opacity-75 cursor-pointer'>
          ...
          <div className='grid grid-cols-1 gap-10 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-3'>
            {/* Our information */}
            <div className='sm:block flex flex-col items-center'>
              <p className='font-medium text-neutral-900 text-center sm:text-left'>
                Our information
              </p>
            ...
            <div className='sm:block flex flex-col items-center'>
              ...
              <ul className='mt-6 text-sm space-y-4 text-center sm:text-left'>
                <li className='text-neutral-700 transition hover:opacity-75 cursor-pointer'>
                  About us
                </li>
